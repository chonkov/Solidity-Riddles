...
describe(NAME, function () {
    ...
    describe("exploit", async function () {
        ...
        it("conduct your attack here", async function () {
			await attackerContract.connect(attackerWallet).deposit(NFTToStakeContract.address, rewardTokenContract.address, depositoorContract.address, 42);
			await ethers.provider.send('evm_increaseTime', [5 * 24 * 3600 + 1]);
